...
<tbody>
  <tr>
    ...
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(0)[4]}}</td>
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(0)[5]}}</td>
  </tr>
  <tr>
    ...
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(1)[4]}}</td>
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(1)[5]}}</td>
  </tr>
  <tr>
    ...
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(2)[4]}}</td>
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(2)[5]}}</td>
  </tr>
  <tr>
    ...
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(3)[4]}}</td>
    <td class="tg-ec4q">{{igra.narisi_vrstico_zacetek(3)[5]}}</td>
  </tr>
</tbody>
</table>
